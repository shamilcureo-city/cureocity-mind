...
function makeRouter(opts: {
  ...
  return {
    ...
    pass6: vi.fn(async () => {
      throw new Error('pass6 not used by note orchestrator');
    }),
    pass7: vi.fn(async () => {
      throw new Error('pass7 not used by note orchestrator');
    }),
    pass8: vi.fn(async () => {
    ...
    passFindings: vi.fn(async () => {
      throw new Error('passFindings not used by note orchestrator');
    }),
