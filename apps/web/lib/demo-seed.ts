...
const CITIES: Record<string, CitySpec> = {
  ...
  hyderabad: {
    city: 'Hyderabad',
    province: 'Telangana',
    langs: ['Telugu', 'English', 'Hindi', 'Urdu'],
    council: 'TSMC',
  },
  warangal: {
    city: 'Warangal',
...
const ROWS: Row[] = [
  // ---- Therapists / psychologists (16) ----
  {
    ...
    vertical: 'THERAPIST',
    cityKey: 'chennai',
    focus: 'Anxiety & perfectionism',
    modalities: ['CBT', 'ACT'],
    years: 11,
    feeInr: 2200,
  },
  {
    name: 'Haneena Farhath M',
    vertical: 'THERAPIST',
    cityKey: 'coimbatore',
    focus: 'Trauma & grief',
    modalities: ['EMDR', 'IFS'],
  ...
  },
  {
    ...
    vertical: 'THERAPIST',
    cityKey: 'kochi',
    focus: 'Adolescents & mood',
    modalities: ['CBT', 'DBT-informed'],
    years: 7,
    feeInr: 1800,
  },
  {
    name: 'Fathima Thasnim',
    vertical: 'THERAPIST',
    cityKey: 'tvm',
    focus: 'Couples & relationships',
    modalities: ['EFT', 'Gottman Method'],
    years: 13,
    feeInr: 2600,
  },
  {
    name: 'Arwa Binth Abeebacker',
    vertical: 'THERAPIST',
    cityKey: 'hyderabad',
  ...
  },
  {
    ...
    vertical: 'THERAPIST',
    cityKey: 'kozhikode',
    focus: 'Psychodynamic & identity',
    modalities: ['Psychodynamic'],
    years: 15,
    feeInr: 3000,
  },
  {
    name: 'Anshida Sheri C',
    vertical: 'THERAPIST',
    cityKey: 'madurai',
    focus: 'Addiction & motivation',
    modalities: ['MI', 'CBT'],
    years: 10,
    feeInr: 1500,
  },
  {
    name: 'Rahsha Shirin V P',
    vertical: 'THERAPIST',
    cityKey: 'mangaluru',
    focus: 'Postpartum & maternal',
    modalities: ['Supportive', 'CBT'],
    years: 9,
    feeInr: 2100,
  },
  {
    ...
    vertical: 'THERAPIST',
    cityKey: 'bengaluru',
    focus: 'Workplace stress & ADHD',
    modalities: ['CBT', 'Coaching'],
    years: 7,
    feeInr: 2800,
  },
  {
    ...
    vertical: 'THERAPIST',
    cityKey: 'tvm',
    focus: 'Eating & body image',
    modalities: ['CBT-E', 'ACT'],
    years: 8,
    feeInr: 2300,
  },
  {
    name: 'Sophiya Babu Rajendran',
    vertical: 'THERAPIST',
    cityKey: 'hubballi',
    focus: 'Anger & impulse',
    modalities: ['DBT-informed', 'CBT'],
    years: 6,
    feeInr: 1400,
  },
  {
  ...
  },
  {
    ...
    vertical: 'THERAPIST',
    cityKey: 'mysuru',
    focus: 'Sleep & health anxiety',
    modalities: ['CBT-I', 'CBT'],
    years: 12,
    feeInr: 2500,
  },
  {
    ...
    vertical: 'THERAPIST',
    cityKey: 'vijayawada',
    focus: 'Grief & life transitions',
    modalities: ['Existential', 'Supportive'],
    years: 10,
    feeInr: 1700,
  },
  {
    name: 'Bella Ann Oommen',
    vertical: 'THERAPIST',
    cityKey: 'thrissur',
    focus: 'Men & relationships',
    modalities: ['CBT', 'EFT'],
    years: 14,
    feeInr: 2000,
  },
...
const UAE_ROWS: UaeRow[] = [
  ...
  {
    name: 'Mohammed Ansary',
    city: 'Dubai',
    province: 'Dubai',
    council: 'DHA',
    specialty: 'Family Medicine',
    langs: ['English', 'Arabic', 'Malayalam'],
    years: 12,
    feeInr: 2500,
  },
  {
  ...
  },
  {
    ...
    council: 'DHA',
    specialty: 'Pediatrics',
    langs: ['English', 'Pashto', 'Urdu'],
    years: 10,
    feeInr: 2000,
  },
  {
    name: 'Stephen R. Grobmyer',
    city: 'Abu Dhabi',
    province: 'Abu Dhabi',
    council: 'DOH',
    specialty: 'Oncology',
