...
const NAV: NavItem[] = [
  ...
  // CP-C — "Plan" is the treatment plan (the plan of care); membership/billing
  // is its own item. Previously "Plan" opened the billing tier, which read as
  // a therapy app hiding the actual plan behind a payment page.
  { href: '/care/plan', label: 'Plan', icon: 'plan' },
  { href: '/care/plan-tier', label: 'Membership', icon: 'membership' },
...
type IconKind = 'home' | 'progress' | 'plan' | 'membership' | 'settings' | 'signout';
...
function Icon({ kind }: { kind: IconKind }) {
  const paths: Record<IconKind, string> = {
    ...
    membership: 'M3 8h18M3 8v9a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V8M3 8V7a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v1M7 15h4',
    settings:
