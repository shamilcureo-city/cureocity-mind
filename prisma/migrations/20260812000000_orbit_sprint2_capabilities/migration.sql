...
-- Additive only: existing vertical fields and queries remain intact.
...
ALTER TABLE "psychologists" ADD COLUMN "profession" "PractitionerProfession";
...
CREATE TABLE "practitioner_capability_grants" (
  "id" TEXT NOT NULL,
  "psychologistId" TEXT NOT NULL,
...
CREATE TABLE "clinic_capability_grants" (
  "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "practitioner_credentials_kind_registrationNumber_issuingAuthority_key"
  ON "practitioner_credentials"("kind", "registrationNumber", "issuingAuthority");
CREATE INDEX "practitioner_credentials_psychologistId_status_idx"
  ON "practitioner_credentials"("psychologistId", "status");
CREATE UNIQUE INDEX "practitioner_capability_grants_psychologistId_capability_source_key"
  ON "practitioner_capability_grants"("psychologistId", "capability", "source");
CREATE INDEX "practitioner_capability_grants_psychologistId_active_idx"
  ON "practitioner_capability_grants"("psychologistId", "active");
CREATE UNIQUE INDEX "clinic_capability_grants_clinicId_capability_key"
  ON "clinic_capability_grants"("clinicId", "capability");
CREATE INDEX "clinic_capability_grants_clinicId_active_idx"
