...
ALTER TABLE "psychologists" ADD COLUMN IF NOT EXISTS "clinicName" TEXT;
ALTER TABLE "psychologists" ADD COLUMN IF NOT EXISTS "clinicAddress" TEXT;
ALTER TABLE "psychologists" ADD COLUMN IF NOT EXISTS "clinicPhone" TEXT;
