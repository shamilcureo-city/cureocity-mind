...
| Review and completion       | `/app/sessions/[id]` opens one Mind Review & Close checklist; advanced record remains linked         | Existing doctor Review & Sign                                       | Product-specific; never replace one with the other               |
