...
| Current authenticated entry | `/app` redirects to canonical `/app/today`; `/app/encounters/new` is the compatibility capture entry | `/app/clinic`                                                       | Product-specific                                                 |
| Canonical home              | `/app/today`; `/app` is a redirect, not a second home                                                | `/app/clinic` remains unchanged                                     | Product-specific                                                 |
...
| Review and completion       | `/app/sessions/[id]` opens Session review; the Note tab owns the sole Mind Review & Close ceremony   | Existing doctor Review & Sign                                       | Product-specific; never replace one with the other               |
