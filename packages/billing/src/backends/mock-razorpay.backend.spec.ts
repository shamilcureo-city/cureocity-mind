...
describe('MockRazorpayBackend', () => {
  it('creates deterministic order ids and accepts the canonical signature', async () => {
    ...
    expect(
      b.verifyCheckoutSignature('order_mock_1_r1', 'pay_x', MOCK_RAZORPAY_SIGNATURE),
    ).toBe(true);
  });
});
...
describe('RazorpayHttpBackend signatures', () => {
  ...
  const SECRET = 'secret';
  const EXPECTED_HEX =
    'cd165584491f0734ce620343b5022ffe092f535a2468bb2d283e32ebbe0cd7eb';
  ...
  it('verifies the checkout-success signature against orderId|paymentId', () => {
    ...
    const EXPECTED =
      '6c4490ce5c4839b0437f2b5dccb1fc7301518f94c6d1165b96d0903bfd33b2ae';
