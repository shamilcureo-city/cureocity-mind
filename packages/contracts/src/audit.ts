...
export const AuditActionSchema = z.enum([
  ...
  'PATIENT_SHARE_REFRESH_REQUESTED',
  ...
  'SESSION_USAGE_REGISTERED',
  'SESSION_USAGE_REPORTED',
  ...
  'CARE_ALLIANCE_PULSE',
  'CARE_CHECKOUT_CREATED',
  'CARE_PLAN_UPGRADED',
  'CARE_PAYMENT_FAILED',
  'CARE_WAITLIST_JOINED',
  'CARE_SESSION_PACK_PURCHASED',
  'CARE_TRIAL_STARTED',
  'CARE_SHARE_CREATED',
  'CARE_SHARE_OPENED',
  'CARE_SHARE_REVOKED',
  'CARE_REFERRAL_LINKED',
  'CARE_REFERRAL_CREDITED',
  'CARE_GRADUATED',
  'CARE_NUDGE_OPTIN',
  'CARE_NUDGE_OPTOUT',
  'CARE_NUDGE_SENT',
